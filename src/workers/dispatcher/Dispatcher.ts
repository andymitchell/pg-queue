...
import { promiseWithTrigger, sleep } from "@andyrmitchell/utils";
...
export class Dispatcher {
    ...
    private loopCompletePromise?: Promise<void>;
    ...
    async onceComplete():Promise<void> {

    }

    private async startLoop() {
        const pwt = promiseWithTrigger<void>();
        this.loopCompletePromise = pwt.promise;
        ...
        try {
            ...
            console.warn("Error in dispatcher loop");
            throw e;
        } finally {
            pwt.trigger();
        }
